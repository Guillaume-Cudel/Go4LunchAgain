...
public class NotificationsService extends FirebaseMessagingService {
    ...
    private FirestoreUserViewModel firestoreUserVM;
    private final int NOTIFICATION_ID = 007;
    private final String NOTIFICATION_TAG = "NOTIF";
    ...
    private void sendVisualNotification(RemoteMessage.Notification notification) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(R.drawable.ic_menu_restaurant)
    ...
    /*private void recoveUsersInformations(){
        firestoreUserVM = Injection.provideFirestoreUserViewModel(getA);
    }*/
}
