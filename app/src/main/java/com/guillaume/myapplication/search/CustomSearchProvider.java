...
public class CustomSearchProvider extends ContentProvider {

    public CustomSearchProvider(){
    }

    public static final String AUTHORITY = "com.guillaume.myapplication.search.CustomSearchProvider";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/restaurants");

    public static final String name = "name";
    public static final String distance = "distanceInMeter";
    ...
    static final String DATABASE_NAME = "WantedRestaurantsDB";
